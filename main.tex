...
A fim de obtermos um modelo dinâmico do sistema, foi utilizada a resposta ao degrau obtida por Martin Jurek \cite{JurekWagnerova2019} e o processo de identificação de um sistema de 
segunda ordem 
